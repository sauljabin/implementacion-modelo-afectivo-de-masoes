...
public class MultipleAgentConfigurationGui extends JDialog {
    ...
    private JCheckBox randomEmotionalStateCheckBox;
    private JSpinner quantitySpinner;

    public MultipleAgentConfigurationGui() {
        setModal(true);
        setTitle(translation.get("gui.multiple_agents_configuration"));
        setSize(600, 500);
    ...
    public static void main(String[] args) {
        MultipleAgentConfigurationGui multipleAgentConfigurationGui = new MultipleAgentConfigurationGui();
        multipleAgentConfigurationGui.setVisible(true);
    }
    ...
    private JPanel createInitialEmotionPanel() {
        JPanel emotionPanel = new JPanel(new MigLayout());
        emotionPanel.setBorder(BorderFactory.createTitledBorder(translation.get("gui.initial_emotional_state")));

        randomEmotionalStateCheckBox = new JCheckBox(translation.get("gui.random"));
        emotionPanel.add(randomEmotionalStateCheckBox, "span 3, wrap");
    ...
    private JPanel createAgentFieldsPanel() {
        ...
        JLabel quantityLabel = new JLabel(translation.get("gui.quantity"));
        agentPanel.add(quantityLabel);

        quantitySpinner = new JSpinner();
        quantitySpinner.setModel(new SpinnerNumberModel(1, 1, 1000, 1));
        agentPanel.add(quantitySpinner, FIELDS_SIZE);
    ...
    public JCheckBox getRandomEmotionalStateCheckBox() {
        return randomEmotionalStateCheckBox;
    }
