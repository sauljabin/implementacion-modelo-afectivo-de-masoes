...
import environment.wikipedia.chart.behaviourModification.AgentsBehaviourModificationChartGui;
import environment.wikipedia.chart.emotionModification.AgentsEmotionModificationChartGui;
import environment.wikipedia.chart.emotionalDispersion.EmotionalDispersionLineChartGui;
import environment.wikipedia.chart.emotionalState.AgentsEmotionalStateChartGui;
import environment.wikipedia.chart.maximunDistance.MaximumDistancesLineChartGui;
...
public class ConfiguratorAgent extends GuiAgent {
    ...
    public ConfiguratorAgent() {
        ...
        knowledgeRules = Arrays.asList(
                new KnowledgeRule(true, "highReputationIncrease", "0.3", "0.3"),
                new KnowledgeRule(true, "mediumReputationIncrease", "0", "0.1"),
                new KnowledgeRule(true, "lowReputationIncrease", "-0.05", "0.05"),
                new KnowledgeRule(true, "highReputationDecrease", "-0.3", "-0.3"),
                new KnowledgeRule(true, "mediumReputationDecrease", "0", "-0.1"),
                new KnowledgeRule(true, "lowReputationDecrease", "-0.05", "-0.05")
        );
