...
public class HappinessEmotionTest {
    ...
    public void shouldReturnCorrectConfiguration() {
        ...
        assertThat(happinessEmotion.getName(), is("happiness"));
        assertThat(happinessEmotion.getLevel(), Is.is(EmotionLevel.INDIVIDUAL));
        assertThat(happinessEmotion.getType(), Is.is(EmotionType.POSITIVE));
    }
