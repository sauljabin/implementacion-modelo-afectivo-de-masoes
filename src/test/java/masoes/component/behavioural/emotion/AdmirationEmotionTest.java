...
public class AdmirationEmotionTest {
    ...
    public void shouldReturnCorrectConfiguration() {
        ...
        assertThat(admirationEmotion.getName(), is("admiration"));
        assertThat(admirationEmotion.getLevel(), Is.is(EmotionLevel.COLLECTIVE));
        assertThat(admirationEmotion.getType(), Is.is(EmotionType.POSITIVE));
    }
