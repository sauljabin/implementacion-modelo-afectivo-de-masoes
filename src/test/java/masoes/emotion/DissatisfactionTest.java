...
public class DissatisfactionTest {
	...
	public void shouldIntersectsWithBoundaryPoints() {
		for (Coordinate coordinate : coordinates) {
			assertTrue(dissatisfaction.getGeometry().intersects(geometryFactory.createPoint(coordinate)));
		}
	}
	...
	public void shouldReturnCorrectEmotionType() {
		assertThat(dissatisfaction.getEmotionType(), Is.is(EmotionType.NEGATIVE_HIGH));
	}
