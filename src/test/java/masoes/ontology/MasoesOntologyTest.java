...
public class MasoesOntologyTest {
    ...
    public void shouldGetAllConcepts() {
        ...
        assertThat(concepts, containsInAnyOrder("ActionStimulus", "BehaviourState", "EmotionState", "ObjectProperty", "ObjectStimulus", "EventStimulus", "Stimulus", "ObjectEnvironment", "CentralEmotion", "EmotionalDispersion", "MaximumDistance"));
    }
